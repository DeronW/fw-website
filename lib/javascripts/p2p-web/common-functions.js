$(function () {
    ...
    if(href.indexOf('#school')){
        $(".header-nav-bar-links li").eq(4).find('a').addClass("active").parent().siblings().find('a').removeClass("active")
    }else if(href.indexOf("notice-corporate-structure")){
        $(".header-nav-bar-links li").eq(3).find('a').addClass("active").parent().siblings().find('a').removeClass("active")
    }
