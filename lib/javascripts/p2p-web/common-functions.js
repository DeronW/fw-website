$(function () {
    ...
    // //头部点击事件
    // $(".header-nav-bar-links").find("li").each(function (index, value) {
    //     let pathname = location.pathname;
    //     let hash = location.hash;
    //     if(pathname.indexOf("notice-corporate-structure")){
    //         $(this).addClass("active").siblings().removeClass("active")
    //     }else if(pathname.indexOf("aboutus")&& hash=="#school"){
    //         $(this).addClass("active").siblings().removeClass("active")
    //     }
    // })
    let hash = location.hash;
    ...
    if(href.indexOf('#school')){
        $(".header-nav-bar-links li").eq(4).find('a').addClass("active");
        $(".header-nav-bar-links li").eq(3).find('a').removeClass("active");
    }else if(href.indexOf("notice-corporate-structure")){
        $(".header-nav-bar-links li").eq(3).find('a').addClass("active");
        $(".header-nav-bar-links li").eq(4).find('a').removeClass("active");
    }
