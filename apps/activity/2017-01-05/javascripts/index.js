        ...
        $UserReady(function (is_login, user) {
            if (is_login) {
                if (time >= oneWeekStart && time <= oneWeekEnd) {
                    $(".pcWeekPack .weekAward").html('本周（1.6-1.12）内，您有效邀友<em>50</em>人，可获工豆<em>100</em>元。');
                } else if(time > oneWeekEnd && time <= marEnd){
                    $(".pcWeekPack .weekAward").html('本周（1.6-1.12）内，您有效邀友<em>50</em>人，可获工豆<em>100</em>元。&nbsp;&nbsp;<div class="beforeWeek" >往周邀友奖励</div>');
                }
            } else {
                $(".pcWeekPack .weekAward").html('请登录后，查看您的邀友数及可获工豆， <a href="https://passport.9888.cn/passport/login?sourceSite=jrgc">立即登录></a>');
