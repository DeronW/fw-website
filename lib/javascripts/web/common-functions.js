...
$(function () {
    // 9888.cn p2p
    // gongchangzx.com
    window.DOMAIN_P2P = document.domain.match(/\.9888\.cn/)
    // console.log(window.DOMAIN_P2P);s
    // window.DOMAIN_P2P = document.domain === '9888.cn'
    window.DOMAIN_ZX = document.domain.match(/\.gongchangzx\.com/)
    // window.DOMAIN_ZX = document.domain === 'gongchangzx.com';
    if(window.DOMAIN_ZX==='.gongchangzx.com'){
