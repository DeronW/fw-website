const January = {
    ...
    "data": {
        "rankNum": 0,
        "totalYearInvest": 11519536.58,
        "totalYearInvestAll": 13260561.229999999,
        "topList": [
            {
                "id": null,
                "applyUname": "130650",
...
const February = {
    ...
    "data": {
        "rankNum": 0,
        "totalYearInvest": 24611805.66,
        "totalYearInvestAll": 26824366.589999996,
        "topList": [
            {
                "id": null,
                "applyUname": "130650",
...
const MonthLadderPC = React.createClass({
    ...
    ajaxPullNewInvest: function (startDate, endDate) {
        if(startDate == '2017-1-6'){
            this.showAndSetData(January)
        }else if(startDate == '2017-2-3') {
            this.showAndSetData(February)
        }else{
            $.ajax({
