...
$(function () {
    ...
    $.get(API_PATH + "/dataTopics/data.shtml", {}, function (data) {
        ...
        //借款相关
        borrow(formatPerson(d.total_borrUserCount),(d.total_borrUserCount / d.total_invest).toFixed(2),d.total_topOnePriInvest,d.total_topTenPriInvest,d.total_relInvest,d.total_relCount)

        //出借用户
        secondPie(d.female, d.male, d.age_level_1, d.age_level_2, d.age_level_3, d.age_level_4, d.age_level_5);
        //出借相关
        lend(formatPerson(d.total_userCount),(d.total_userCount / d.total_invest).toFixed(2),d.total_topOneBorrInvest,d.total_topTenBorrInvest)
        //承受能力
