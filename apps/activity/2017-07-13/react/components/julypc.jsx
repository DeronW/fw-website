...
class ContentPCPanel extends React.Component {
    render() {
...
class BounsPCPanel extends React.Component {
    render() {
        return <div className="pc-bonus">
...
class ExplainPCPanel extends React.Component {
    render() {
        return <div className="pc-explain">
