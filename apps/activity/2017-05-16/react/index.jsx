...
$(() => {
    ...
    Promise.all([
        ...
        let C = navigator.userAgent.match(/Android|iPhone|iPad|Mobile/i) ?
            <RefactorDrawMobile isLogin={isLogin} timestamp={timestamp} gotoLogin={gotoLogin} closePopHandler={closePopHandler} prize_list={prize_list} /> :
            <RefactorDrawPC isLogin={isLogin} timestamp={timestamp} gotoLogin={gotoLogin} closePopHandler={closePopHandler} prize_list={prize_list} />;
